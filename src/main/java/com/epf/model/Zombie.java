...
public class Zombie {
    ...
    //Paramètres de la classe zombie
    ...
    private Long id_map; //Long au lieu de long permet de renseigner null dans le cas d'une suppression de map

    // Constructeur par défaut
    public Zombie() {}

    // Constructeur complet
    public Zombie(long id_zombie, String nom, int point_de_vie, double attaque_par_seconde,
